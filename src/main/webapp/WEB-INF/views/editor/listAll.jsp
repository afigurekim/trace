	...
	<section id="portfolio"  style="margin-top:0px; margin-bottom:120px; overflow:hidden;">
		...
		<script type="text/javascript">
			document.write("<ul class='portfolio-filter fade-down center'>");
				 ...
				 if(window.location.href.indexOf("kor")!=-1){
					 document.write("<li><a class='btn btn-outlined btn-primary active'id='listAll'>전체보기</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
					  ...
					  document.write("<li><a class='btn btn-outlined btn-primary active'id='listAll'>ALL</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
					  ...
					  document.write("<li><a class='btn btn-outlined btn-primary active'id='listAll'>所有的</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
		...
		<tbody>
			<c:forEach items="${list }" var="vo">
				<tr>
					...
					<td class = "tb_regdate"><fmt:formatDate pattern="yyyy-MM-dd"
							value="${vo.regdate }" /></td>
...
<div class="text-center">
	<ul class="pagination">
		<c:if test="${pageMaker.prev }">
			<li><a href="listAll?page=${pageMaker.startPage -1  }"> <span
		...
		<c:if test="${pageMaker.next && pageMaker.endPage>0 }">
			<li><a href="listAll?page=${pageMaker.endPage +1 }"> <span
