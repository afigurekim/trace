			...
			document.write("<ul class='portfolio-filter fade-down center'>");
				 ...
				 if(window.location.href.indexOf("kor")!=-1){
					 document.write("<li><a class='btn btn-outlined btn-primary 'id='listAll'>전체보기</a></li>");
					  ...
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary active' id='edu'>교 육</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
					  ...
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary active' id='edu'>EDUCATION</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
					  ...
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary active' id='edu'>教育</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
