			...
			document.write("<ul class='portfolio-filter fade-down center'>");
				 ...
				 if(window.location.href.indexOf("kor")!=-1){
					 document.write("<li><a class='btn btn-outlined btn-primary 'id='listAll'>전체보기</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary active' id='family'>가족</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary' id='couple'>데이트</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
					  ...
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary active' id='family'>FAMILY</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary' id='couple'>DATE</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
					  ...
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary active' id='family'>一家人</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary' id='couple'>恋人</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
					  ...
					  document.write("<li><a class='btn btn-outlined btn-primary 'id='listAll'>전체보기</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary active' id='family'>가 족</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary' id='couple'>데이트</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary' id='edu'>교 육</a></li>");
			...
			<div class="text-center">
				<ul class="pagination">
					<c:if test="${pageMaker.prev }">
						<li><a href="theme_family?page=${pageMaker.startPage -1  }">
					...
					<c:forEach begin="${pageMaker.startPage }"
						...
						<li
							...
							<a href="theme_family?page=${idx }">${idx }</a>
						</li>
					</c:forEach>
					<c:if test = "${pageMaker.next && pageMaker.endPage>0 }">
						<li><a href="theme_family?page=${pageMaker.endPage +1 }">
