			...
			document.write("<ul class='portfolio-filter fade-down center'>");
				 ...
				 if(window.location.href.indexOf("kor")!=-1){
					 document.write("<li><a class='btn btn-outlined btn-primary 'id='listAll'>전체보기</a></li>");
					  ...
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary active' id='religion'>종 교</a></li>");
				  }else if(window.location.href.indexOf("eng")!=-1){
					  ...
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary active' id='religion'>RELIGION</a></li>");
				  }else if(window.location.href.indexOf("china")!=-1){
					  ...
					  document.write("&nbsp;&nbsp;&nbsp;");
					  document.write("<li><a class='btn btn-outlined btn-primary active' id='religion'>宗教</a></li>");
				  }else{
					  document.write("<li><a class='btn btn-outlined btn-primary 'id='listAll'>전체보기</a></li>");
					  document.write("&nbsp;&nbsp;&nbsp;");
			...
			<div class="text-center">
				<ul class="pagination">
					<c:if test="${pageMaker.prev }">
						<li><a href="theme_edu?page=${pageMaker.startPage -1  }">
					...
					<c:forEach begin="${pageMaker.startPage }"
						...
						<li
							...
							<a href="theme_edu?page=${idx }">${idx }</a>
						</li>
					</c:forEach>
					<c:if test = "${pageMaker.next && pageMaker.endPage>0 }">
						<li><a href="theme_edu?page=${pageMaker.endPage +1 }">
