        ...
        <section id="portfolio" class="white">
            <div class="container">
                    ...
                    if(window.location.href.indexOf("eng")!=-1){
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='all_period' href='#' data-filter='*'>ALL</a></li>");
                    ...
                    <div class="text-center">
						<ul class="pagination">
							...
							<script type="text/javascript">
							 if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href=/eng/period?page=${pageMaker.startPage-1}&laquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href=/china/period?page=${pageMaker.startPage-1}&laquo;</a></li>");

		                          }else{
			                            document.write("<li><a href=/period?page=${pageMaker.startPage-1}&laquo;</a></li>");
							...
							<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
								...
								<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<a href='/eng/period?page=${idx}'>${idx}</a>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                       document.write("<a href='/china/period?page=${idx}'>${idx}</a>");

		                          }else{
				                       document.write("<a href='/period?page=${idx}'>${idx}</a>");
							...
							<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href='/eng/period?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href='/china/period?page=${pageMaker.endPage +1}'>&raquo;</a></li>");

		                          }else{
			                            document.write("<li><a href='/period?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
