...
$(function(){
		if(window.location.href=="http://localhost:8181/period/hyundae" || window.location.href.includes("http://localhost:8181/period/hyundae?page="))
		{
			$("#hyundae").css('background-color','wheat');
		}	
	...
	<div class="glist">
		...
		<ul class="pagination">
			...
			<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
				...
				<a href="/period/hyundae?page=${idx}">${idx}</a>
				</li>
			</c:forEach>
			
			<c:if test="${pageMaker.next && pageMaker.endPage>0 }">
				<li><a href="/period/hyundae?page=${pageMaker.endPage +1}">&raquo;</a></li>
			</c:if>
