...
#img_size{
 background-image: url("../resources/imgs/cloud.png");
		...
		#single-page-slider {
			background-image: url("../../../resources/imgs/banner/period-josun-banner.jpg");
    ...
    <div id="content-wrapper">
        ...
        <script>
                    if(window.location.href.indexOf("eng")!=-1){
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='josun' data-filter='*'>Joseon</a></li>");
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='josun' data-filter='*'>朝鲜</a></li>");
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='josun' data-filter='*'>조선시대</a></li>");
                    ...
                    <div class="text-center">
						<ul class="pagination">
							...
							<script type="text/javascript">
							 if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href=/eng/period/josun?page=${pageMaker.startPage-1}&laquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href=/china/period/josun?page=${pageMaker.startPage-1}&laquo;</a></li>");

		                          }else{
			                            document.write("<li><a href=/period/josun?page=${pageMaker.startPage-1}&laquo;</a></li>");
							...
							<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
								...
								<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<a href='/eng/period/josun?page=${idx}'>${idx}</a>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                       document.write("<a href='/china/period/josun?page=${idx}'>${idx}</a>");

		                          }else{
				                       document.write("<a href='/period/josun?page=${idx}'>${idx}</a>");
							...
							<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href='/eng/period/josun?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href='/china/period/josun?page=${pageMaker.endPage +1}'>&raquo;</a></li>");

		                          }else{
			                            document.write("<li><a href='/period/josun?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
