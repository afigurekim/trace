...
#img_size{
 background-image: url("../resources/imgs/cloud.png");
		...
		#single-page-slider {
			background-image: url("../../../resources/imgs/banner/period-korea-banner.jpg");
        ...
        <section id="portfolio" class="white">
            <div class="container">
                    ...
                    if(window.location.href.indexOf("eng")!=-1){
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='korea' data-filter='*'>Goryeo</a></li>");
                    	...
                    	document.write("<ul class='portfolio-filter fade-down center'>");
                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='all_period' href='#' data-filter='*'>全面查看</a></li>");
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='korea' data-filter='*'>高丽</a></li>");
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='korea' data-filter='*'>고려시대</a></li>");
                    ...
                    <div class="text-center">
						<ul class="pagination">
							...
							<script type="text/javascript">
							 if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href=/eng/period/korea?page=${pageMaker.startPage-1}&laquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href=/china/period/korea?page=${pageMaker.startPage-1}&laquo;</a></li>");

		                          }else{
			                            document.write("<li><a href=/period/korea?page=${pageMaker.startPage-1}&laquo;</a></li>");
							...
							<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
								...
								<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<a href='/eng/period/korea?page=${idx}'>${idx}</a>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                       document.write("<a href='/china/period/korea?page=${idx}'>${idx}</a>");

		                          }else{
				                       document.write("<a href='/period/korea?page=${idx}'>${idx}</a>");
							...
							<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href='/eng/period/korea?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href='/china/period/korea?page=${pageMaker.endPage +1}'>&raquo;</a></li>");

		                          }else{
			                            document.write("<li><a href='/period/korea?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
