...
#img_size{
 background-image: url("../resources/imgs/cloud.png");
		...
		#single-page-slider {
			background-image: url("../../../resources/imgs/banner/period-samgook-banner.jpg");
        ...
        <section id="portfolio" class="white">
            <div class="container">
                    ...
                    if(window.location.href.indexOf("eng")!=-1){
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='samgook' data-filter='*'>Three Kindoms</a></li>");
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary' id='hyundae' data-filter='*'>Modern</a></li>");
                    }else if(window.location.href.indexOf("china")!=-1){
                    	document.write("<ul class='portfolio-filter fade-down center'>");
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='samgook' data-filter='*'>三国</a></li>");
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary' id='hyundae' data-filter='*'>近现代 </a></li>");
                    }else{
                    	document.write("<ul class='portfolio-filter fade-down center'>");
                    	document.writeln("<li><a class='btn btn-outlined btn-primary' id='all_period' href='#' data-filter='*'>전체보기</a></li>");
                    	document.writeln("<li><a class='btn btn-outlined btn-primary' id='sunsa' data-filter='*'>선사시대</a></li>");
                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='samgook' data-filter='*'>삼국시대</a></li>");
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary' id='hyundae' data-filter='*'>근현대</a></li>");
                    }
                    ...
                    <div class="text-center">
						<ul class="pagination">
							...
							<script type="text/javascript">
							 if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href=/eng/period/samgook?page=${pageMaker.startPage-1}&laquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href=/china/period/samgook?page=${pageMaker.startPage-1}&laquo;</a></li>");

		                          }else{
			                            document.write("<li><a href=/period/samgook?page=${pageMaker.startPage-1}&laquo;</a></li>");
							...
							<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
								...
								<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<a href='/eng/period/samgook?page=${idx}'>${idx}</a>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                       document.write("<a href='/china/period/samgook?page=${idx}'>${idx}</a>");

		                          }else{
				                       document.write("<a href='/period/samgook?page=${idx}'>${idx}</a>");
							...
							<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href='/eng/period/samgook?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href='/china/period/samgook?page=${pageMaker.endPage +1}'>&raquo;</a></li>");

		                          }else{
			                            document.write("<li><a href='/period/samgook?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
