...
#img_size{
 background-image: url("../resources/imgs/cloud.png");
		...
		#single-page-slider {
			background-image: url("../../../resources/imgs/banner/period-sunsa-banner.jpg");
        ...
        <section id="portfolio" class="white">
            <div class="container">
                    ...
                    if(window.location.href.indexOf("eng")!=-1){
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='sunsa' data-filter='*'>Prehistoric</a></li>");
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='sunsa' data-filter='*'>禅师</a></li>");
                    	...
                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='sunsa' data-filter='*'>선사시대</a></li>");
