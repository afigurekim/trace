        ...
        <section id="portfolio" class="white">
            <div class="container">
                    <script>
                    	...
                    	if(window.location.href.indexOf("eng")!=-1){
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='all_region' href='#' data-filter='*'>ALL</a></li>");
	                    	...
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='all_region' href='#' data-filter='*'>全面查看</a></li>");
	                    	...
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='all_region' href='#' data-filter='*'>전체보기</a></li>");
                    ...
                    <div class="text-center">
						<ul class="pagination">
							...
							<script type="text/javascript">
							 if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href=/eng/region/all?page=${pageMaker.startPage-1}&laquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href=/china/region/all?page=${pageMaker.startPage-1}&laquo;</a></li>");

		                          }else{
			                            document.write("<li><a href=/region/all?page=${pageMaker.startPage-1}&laquo;</a></li>");
							...
							<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
								...
								<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<a href='/eng/region/all?page=${idx}'>${idx}</a>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                       document.write("<a href='/china/region/all?page=${idx}'>${idx}</a>");

		                          }else{
				                       document.write("<a href='/region/all?page=${idx}'>${idx}</a>");
							...
							<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href='/eng/region/all?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href='/china/region/all?page=${pageMaker.endPage +1}'>&raquo;</a></li>");

		                          }else{
			                            document.write("<li><a href='/region/all?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
