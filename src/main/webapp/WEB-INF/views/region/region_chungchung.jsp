            ...
            <div class="container">
                 ...
                 <script>
                    	...
                    	if(window.location.href.indexOf("eng")!=-1){
	                    	...
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active'  id='chungchung' href='#' data-filter='*'>Chungcheong</a></li>");
	                    	...
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active'  id='chungchung' href='#' data-filter='*'>忠清道</a></li>");
	                    	...
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active'  id='chungchung' href='#' data-filter='*'>충청도</a></li>");
