...
#img_size{
 background-image: url("../resources/imgs/cloud.png");
		...
		#single-page-slider {
			background-image: url("../../../resources/imgs/banner/region-incheon-banner.jpg");
            ...
            <div class="container">
                    ...
                    <script>
                    	...
                    	if(window.location.href.indexOf("eng")!=-1){
	                    	...
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active'  id='incheon' href='#' data-filter='*'>Incheon</a></li>");
	                    	...
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active'  id='incheon' href='#' data-filter='*'>仁川</a></li>");
	                    	...
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active'  id='incheon' href='#' data-filter='*'>인천</a></li>");
                    ...
                    <div class="text-center">
						<ul class="pagination">
							...
							<script type="text/javascript">
							 if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href=/eng/region/incheon?page=${pageMaker.startPage-1}&laquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href=/china/region/incheon?page=${pageMaker.startPage-1}&laquo;</a></li>");

		                          }else{
			                            document.write("<li><a href=/region/incheon?page=${pageMaker.startPage-1}&laquo;</a></li>");
							...
							<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
								...
								<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<a href='/eng/region/incheon?page=${idx}'>${idx}</a>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                       document.write("<a href='/china/region/incheon?page=${idx}'>${idx}</a>");

		                          }else{
				                       document.write("<a href='/region/incheon?page=${idx}'>${idx}</a>");
							...
							<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href='/eng/region/incheon?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
