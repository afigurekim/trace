...
$(function(){
		if(window.location.href=="http://localhost:8181/region/kangwon" || window.location.href.includes("http://localhost:8181/region/kangwon?page="))
		{
			$("#kangwon").css('background-color','wheat');
		}	
