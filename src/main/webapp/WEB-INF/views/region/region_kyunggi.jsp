            ...
            <div class="container">
                    ...
                    <script>
                    	...
                    	if(window.location.href.indexOf("eng")!=-1){
	                    	...
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active'  id='kyunggi' href='#' data-filter='*'>Kyunggi</a></li>");
	                    	...
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active'  id='kyunggi' href='#' data-filter='*'>京畿道</a></li>");
	                    	...
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active'  id='kyunggi' href='#' data-filter='*'>경기도</a></li>");
