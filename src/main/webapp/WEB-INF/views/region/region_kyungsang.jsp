...
$(function(){
		if(window.location.href=="http://localhost:8181/region/kyungsang" || window.location.href.includes("http://localhost:8181/region/kyungsang?page="))
		{
			$("#kyungsang").css('background-color','wheat');
		}	
