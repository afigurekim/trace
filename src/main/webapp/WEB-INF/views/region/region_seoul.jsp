            ...
            <div class="container">
                    ...
                    <script>
                    	...
                    	if(window.location.href.indexOf("eng")!=-1){
	                    	...
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='seoul' data-filter='*'>Seoul</a></li>");
	                    	...
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='seoul' data-filter='*'>首尔</a></li>");
	                    	...
	                    	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='seoul' data-filter='*'>서울</a></li>");
