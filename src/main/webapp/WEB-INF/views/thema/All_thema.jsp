        ...
        <section id="portfolio" class="white">
            <div class="container">
                    <script>
                    	...
                    	if(window.location.href.indexOf("eng")!=-1){
                    		document.writeln("<li><a class='btn btn-outlined btn-primary active' id='all_thema' href='#' data-filter='*'>ALL</a></li>");
                    		...
                    		document.writeln("<li><a class='btn btn-outlined btn-primary active' id='all_thema' href='#' data-filter='*'>전체보기</a></li>");
                    ...
                    <div class="text-center">
						<ul class="pagination">
							...
							<script type="text/javascript">
							 if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href=/eng/thema?page=${pageMaker.startPage-1}&laquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href=/china/thema?page=${pageMaker.startPage-1}&laquo;</a></li>");

		                          }else{
			                            document.write("<li><a href=/thema?page=${pageMaker.startPage-1}&laquo;</a></li>");
							...
							<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
								...
								<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<a href='/eng/thema?page=${idx}'>${idx}</a>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                       document.write("<a href='/china/thema?page=${idx}'>${idx}</a>");

		                          }else{
				                       document.write("<a href='/thema?page=${idx}'>${idx}</a>");
							...
							<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href='/eng/thema?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href='/china/thema?page=${pageMaker.endPage +1}'>&raquo;</a></li>");

		                          }else{
			                            document.write("<li><a href='/thema?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
