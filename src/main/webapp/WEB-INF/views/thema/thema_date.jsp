...
#img_size{
 background-image: url("../resources/imgs/cloud.png");
		...
		#single-page-slider {
			background-image: url("../../../resources/imgs/banner/thema-date-banner.jpg");
            ...
            <div class="container">
                 ...
                 <script>
                    	...
                    	if(window.location.href.indexOf("eng")!=-1){
                        	...
                        	document.writeln("<li><a class='btn btn-outlined btn-primary' id='study' href='#' data-filter='*'>Study</a></li>");
                        	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='date' href='#' data-filter='*'>Date</a></li>");
                        	...
                        	document.writeln("<li><a class='btn btn-outlined btn-primary' id='study' href='#' data-filter='*'>教育</a></li>");
                        	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='date' href='#' data-filter='*'>约会</a></li>");
                        	document.writeln("<li><a class='btn btn-outlined btn-primary' id='family' href='#' data-filter='*'>家族</a></li>");

                    	}else{
                    		
                    		document.writeln("<li><a class='btn btn-outlined btn-primary' id='all_thema' href='#' data-filter='*'>전체보기</a></li>");
                        	document.writeln("<li><a class='btn btn-outlined btn-primary' id='study' href='#' data-filter='*'>교육</a></li>");
                        	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='date' href='#' data-filter='*'>데이트</a></li>");
                    ...
                    <div class="text-center">
						<ul class="pagination">
							...
							<script type="text/javascript">
							 if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href=/eng/thema/date?page=${pageMaker.startPage-1}&laquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href=/china/thema/date?page=${pageMaker.startPage-1}&laquo;</a></li>");

		                          }else{
			                            document.write("<li><a href=/thema/date?page=${pageMaker.startPage-1}&laquo;</a></li>");
							...
							<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
								...
								<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<a href='/eng/thema/date?page=${idx}'>${idx}</a>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                       document.write("<a href='/china/thema/date?page=${idx}'>${idx}</a>");

		                          }else{
				                       document.write("<a href='/thema/date?page=${idx}'>${idx}</a>");
							...
							<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href='/eng/thema/date?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href='/china/thema/date?page=${pageMaker.endPage +1}'>&raquo;</a></li>");

		                          }else{
			                            document.write("<li><a href='/thema/date?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
