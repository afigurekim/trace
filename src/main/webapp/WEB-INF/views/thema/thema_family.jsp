            ...
            <div class="container">
                   ...
                   <script>
                    	...
                    	if(window.location.href.indexOf("eng")!=-1){
                        	...
                        	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='family' href='#' data-filter='*'>Family</a></li>");
                        	...
                        	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='family' href='#' data-filter='*'>家族</a></li>");
                        	...
                        	document.writeln("<li><a class='btn btn-outlined btn-primary active' id='family' href='#' data-filter='*'>가족</a></li>");
