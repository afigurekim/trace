        ...
        <section id="portfolio" class="white">
            <div class="container">
                    ...
                    <ul class="portfolio-filter fade-down center">
                        ...
                        <li><a class="btn btn-outlined btn-primary active" id="study" data-filter="*">
	                        <script type="text/javascript">
                    ...
                    <div class="text-center">
						<ul class="pagination">
							...
							<script type="text/javascript">
							 if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href=/eng/thema/study?page=${pageMaker.startPage-1}>&laquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href=/china/thema/study?page=${pageMaker.startPage-1}>&laquo;</a></li>");

		                          }else{
			                            document.write("<li><a href=/thema/study?page=${pageMaker.startPage-1}>&laquo;</a></li>");
							...
							<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
								...
								<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<a href='/eng/thema/study?page=${idx}'>${idx}</a>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                       document.write("<a href='/china/thema/study?page=${idx}'>${idx}</a>");

		                          }else{
				                       document.write("<a href='/thema/study?page=${idx}'>${idx}</a>");
							...
							<script type="text/javascript">
								if(window.location.href.indexOf("eng")!=-1){
		                            document.write("<li><a href='/eng/thema/study?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
		                          }else if(window.location.href.indexOf("china")!=-1){
			                            document.write("<li><a href='/china/thema/study?page=${pageMaker.endPage +1}'>&raquo;</a></li>");

		                          }else{
			                            document.write("<li><a href='/thema/study?page=${pageMaker.endPage +1}'>&raquo;</a></li>");
